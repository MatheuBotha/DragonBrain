...
\paragraph{•}
Graphics engine are not traditionally developed under the traditional OO approach. This is mainly due to various performance issue that graphical processing encounters with Object Orientation. Instead a more effective approach is data-driven design. 
Its basic premise is simple: construct your code around the data structures, and describe what you want to achieve in terms of manipulations of these structures.
...
\paragraph{•}
The basic premise of data orientated design is to design the code around the data, instead of abstracting the data behind models.while this may seem counter intuitive it is still possible to achieve 
