...
int Landscape3D::init_resources() {
    program = create_program("Shaders/graph3D.v.glsl", "Shaders/graph3D.f.glsl");
...
void Landscape3D::free_resources() {
    glDeleteProgram(program);
}

void Landscape3D::display() {
...
void Landscape3D::keyDown(SDL_KeyboardEvent *ev) {
...
void Landscape3D::windowEvent(SDL_WindowEvent *ev) {
    switch(ev->event) {
...
void Landscape3D::mainLoop(SDL_Window *window) {
    while (true) {
        display();
