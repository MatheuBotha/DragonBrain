...
Cube::Cube(GLSLProgram shaderProgram, Texture* texture1, Texture* texture2)
{
    this->shaderProgram = shaderProgram;
...
void Cube::draw(GLfloat deltaTime)
{
    //printf("Drawing cube\n");
...
//    glBindTexture(GL_TEXTURE_2D, _texture2);
//    glUniform1i(shaderProgram.getUniformLocation("ourTexture2"), 1);
...
void Cube::deactivateShader()
{
    shaderProgram.unuse();
}

void Cube::rotate(GLfloat angle, glm::vec3 rotationVector)
{
