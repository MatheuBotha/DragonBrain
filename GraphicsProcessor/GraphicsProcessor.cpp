...
//    printf("Finished making particle system\n");
    ...
    while(true){
        ...
        for(int i=0; i<numInstances; ++i)
        {
            ...
            textRenderer.translate(glm::vec3(-1,0,1));
            //textRenderer.rotate(glm::radians(-90.0f),glm::vec3(0,1,0));
            textRenderer.rotate(glm::radians(-90.0f),glm::vec3(1,0,0));
        ...
        buff<<currentFPS;
        textRenderer.renderText("fps: " + buff.str(), 0.0f, 0.0f, 1.0f, glm::vec3(float(51)/255, float(102)/255, float(255)/255));
